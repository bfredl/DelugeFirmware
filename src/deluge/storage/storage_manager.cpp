...
// numChars may be up to 8
void StorageManager::writeAttributeHexBytes(char const* name, uint8_t *data, int numBytes, bool onNewLine) {
...
int StorageManager::readTagOrAttributeValueHexBytes(uint8_t *bytes, int maxLen) {
	switch (xmlArea) {
...
int StorageManager::readHexBytesUntil(uint8_t *bytes, int maxLen, char endChar) {
	int read;
	char thisChar;
