...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_DEXED_EDITOR, "OLD DX7 editor"},
        {STRING_FOR_DEXED_BROWSER, "load DX7 .syx file"},
        {STRING_FOR_DEXED_CARTRIDGE, "DX7 presets"},
        {STRING_FOR_DEXED_PARAM, "DX7 param"},
        {STRING_FOR_DEXED_GLOBAL_PARAMS, "DX7 parameters"},
        {STRING_FOR_DEXED_OPERATOR_PARAMS, "DX7 operator *"},
        {STRING_FOR_DEXED_ENGINE_SELECT, "engine version"},
