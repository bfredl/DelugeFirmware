...
PLACE_SDRAM_DATA Language seven_segment{
    "Seven Segment",
    {
        ...
        {STRING_FOR_DEXED_1, "DX7"},
        {STRING_FOR_DEXED_EDITOR, "OLDE"},
        {STRING_FOR_DEXED_BROWSER, "SYX"},
        {STRING_FOR_DEXED_CARTRIDGE, "PRES"},
        {STRING_FOR_DEXED_PARAM, "PARM"},
        {STRING_FOR_DEXED_GLOBAL_PARAMS, "EDIT"},
        {STRING_FOR_DEXED_ENGINE_SELECT, "ENGI"},
