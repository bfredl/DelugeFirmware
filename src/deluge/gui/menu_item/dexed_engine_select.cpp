...
DexedEngineSelect dexedEngineSelect{l10n::String::STRING_FOR_DEXED_ENGINE_SELECT};

void DexedEngineSelect::beginSession(MenuItem* navigatedBackwardFrom) {
	readValueAgain();
}

void DexedEngineSelect::readValueAgain() {
...
void DexedEngineSelect::selectEncoderAction(int32_t offset) {
...
MenuItem* DexedEngineSelect::selectButtonPress() {
	return nullptr;
}
