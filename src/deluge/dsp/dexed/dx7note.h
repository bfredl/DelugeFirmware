...
public:
	...
	void setEngineVintage();
	void setEngineModern(bool neon = true);
};
...
public:
	...
	// worth it...
	void compute(int32_t* buf, int n, int pitch, const Dx7Patch* ctrls_patch, const Dx7VoiceCtrl* ctrls_voice);
