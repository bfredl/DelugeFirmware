...
bool Dx7UI::renderSidebar(uint32_t whichRows, RGB image[][kDisplayWidth + kSideBarWidth],
...
bool Dx7UI::renderMainPads(uint32_t whichRows, RGB image[][kDisplayWidth + kSideBarWidth],
