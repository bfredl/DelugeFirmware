...
#define OSC_TYPE_DEXED 8
#define OSC_TYPE_INPUT_L 9
#define OSC_TYPE_INPUT_R 10
#define OSC_TYPE_INPUT_STEREO 11

#define NUM_OSC_TYPES_RINGMODDABLE OSC_TYPE_DEXED

#define NUM_OSC_TYPES 12
